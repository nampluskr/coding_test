...
LinkedList<int> head[5][MAX_TABLE];
...
void addDB(INFO info)
{
    ...
    head[0][hashkey1].push_back(cIdx);
    head[1][hashkey2].push_back(cIdx);
    head[2][hashkey3].push_back(cIdx);
    head[3][hashkey4].push_back(cIdx);
    head[4][hashkey5].push_back(cIdx);
}
...
int newCompound(INFO info)
{
    ...
    for (auto temp = head[0][hashkey1].head; temp; temp = temp->next) {
        int i = temp->data;
    ...
    for (auto temp = head[1][hashkey2].head; temp; temp = temp->next) {
        int i = temp->data;
    ...
    for (auto temp = head[2][hashkey3].head; temp; temp = temp->next) {
        int i = temp->data;
    ...
    for (auto temp = head[3][hashkey4].head; temp; temp = temp->next) {
        int i = temp->data;
    ...
    for (auto temp = head[4][hashkey5].head; temp; temp = temp->next) {
        int i = temp->data;
