...
vector<News> news;			// (1 ≤ mNewsID ≤ 1,000,000,000)
vector<Channel> channels;	// (1 ≤ mChannelID ≤ 1,000,000,000)
vector<User> users;			// (1 ≤ mUID ≤ 1,000,000,000)
...
int offerNews(int mTime, int mNewsID, int mDelay, int mChannelID)
{
    ...
    newsPQ.push({ news[nIdx].newsID, news[nIdx].alarm_time });
